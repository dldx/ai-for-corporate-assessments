		...
		<div class="cancel cursor-auto">
			...
			{#if stepNo == 3}
				<ul class="list-disc pl-5">
					...
					<li>These queries could be based on expert intuition</li>
					<li>
			...
			{#if stepNo == 4}
				<ul class="list-disc pl-5">
					...
					<li>Use <a href="https://blog.google/technology/ai/google-gemini-ai/" target="_blank">Google Gemini</a> to convert scanned PDFs to text.</li>
				</ul>
			{/if}
			{#if stepNo == 5}
            <ul class="list-disc pl-5">
            ...
            <ul class="list-disc pl-5">
                <li>
                    Pre-filter potential documents using text search (eg. specific keywords or sites)
                </li>
                <li>
                    Retrieve most relevant chunks of text from database using several queries
                </li>
                </ul>
			{/if}
			{#if stepNo == 7}
            <ul class="list-disc pl-5">
                <li>
                    Use a generative model (eg. GPT-4o) to generate a response to the original question, passing in relevant chunks, metadata, and the question itself.
                </li>
                <li>
